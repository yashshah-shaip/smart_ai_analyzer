...
export type RiskAnalysisData = z.infer<typeof riskAnalysisSchema>;
...
export type InvestmentRecord = typeof investments.$inferSelect;
...
export type ForecastRecord = typeof forecasts.$inferSelect;
